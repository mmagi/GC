...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            var detail = $(element).attr('detail');
            ...
            $.each(dataprovider, function (index, option) {
                if ($.isArray(option.children)) {
                    ...
                    forEach(option.children, function(subOption) {
                        optionDOM += '<option value="' + subOption.value + (subOption.detail?('" detail="'+subOption.detail+'">'):'">') + (subOption.label || subOption.value) + '</option>';
                    });

                    optionDOM += '</optgroup>';
                }
                else {
                    optionDOM += '<option value="' + option.value + (option.detail?('" detail="'+option.detail+'">'):'">') + (option.label || option.value) + '</option>';
                }
            });
